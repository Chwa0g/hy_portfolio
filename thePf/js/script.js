$(function(){
	...
	$(window).on('scroll',function(){
		...
		if (sct>=0 && sct<10){
			$('#gnb').removeClass('on');
		}else if (sct>=10 && sct<6900){
			$('#gnb').addClass('on');
		}else if (sct>=6900 && sct<9000){
			$('#gnb').removeClass('on');
		}
	});
	...
	$(window).on('scroll',function(){
		...
		} else if (scroll>=6000 && scroll<6800) {
			$('.menu li a').removeClass();
			$('.menu li a').eq(7).addClass('on');	
		} else if (scroll>=6800 && scroll<9000) {
			$('.menu li a').removeClass();
	...
	$(window).scroll(function(){
		...
		if (sct>6900){
			$('#gnb').stop().animate({height:'120px'},500).css({background:'#444444'});
			$('.menu ul li a').addClass('white');
			$('.footer_box').stop().animate({top:'40px',opacity:1},1000);
			$('.menu ul li a').eq(9).css({color:'#cbb26a'});
		} else {
			$('#gnb').stop().animate({height:'70px'},500).css({background:'#ffffff'});
			$('.menu ul li a').removeClass('white');
			$('.footer_box').stop().animate({top:'500px',opacity:0},1000);
			$('.menu ul li a').eq(9).css({color:'#777777'});
		}
	});
	/* /////////////////////epilogue////////////////////// */
	...
	/* /////////////////////top button////////////////////// */
	$('#top').hover(function(){
		$(this).stop().animate({height:100,opacity:1},500);
	},function(){
		$(this).stop().animate({height:50,opacity:0.7},500);
	});
	...
	$(window).on('scroll',function(){
		...
		if (scroll>0 && scroll<800) {
			$('#top').fadeOut();
		} else if (scroll>=800 && scroll<9000) {
			$('#top').fadeIn();
		}
	});
	/* /////////////////////top button////////////////////// */
